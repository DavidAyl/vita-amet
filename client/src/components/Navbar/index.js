      ...
      <>
        ...
        <nav className="navbar navbar-expand-lg bg-light navbar-light fixed-top py-5">
          ...
          <div className="container-fluid">
            ...
            {/* <!-- Toggle button --> */}
            <button className="navbar-toggler border-0" type="button" data-mdb-toggle="collapse" data-mdb-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
              <FaBars />
            </button>
