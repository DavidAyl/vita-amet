								...
								<form id="contact-form" role="form">
									...
									<div className="controls">
										...
										<div className="row">
											<div className="col-md-6">
												<div className="form-group">
													<label for="form_name" className='m-2'>Firstname *</label>
											...
											<div className="col-md-6">
												<div className="form-group">
													<label for="form_lastname" className='m-2'>Lastname *</label>
										...
										<div className="row">
											<div className="col-md-6">
												<div className="form-group">
													<label for="form_email" className='m-2'>Email *</label>
											...
											<div className="col-md-6">
												<div className="form-group">
													<label for="form_need" className='m-2'>Please specify your need *</label>
										...
										<div className="row">
											<div className="col-md-12">
												<div className="form-group">
													<label for="form_message" className='m-2'>Message *</label>
