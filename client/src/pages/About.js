        ...
        <div className="container-fluid">
          <div className="row mx-5">
            <div className="col-12 text-center">
              <img className="img-fluid" src='https://d3rr2gvhjw0wwy.cloudfront.net/uploads/mandators/27199/file-manager/adventure-tourism.jpg' alt='adventure'></img>
              <h1 className='py-3 titles'>about us</h1>
